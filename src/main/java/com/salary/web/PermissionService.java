...
public class PermissionService
{
    ...
    /** 没有权限，hidden用于前端隐藏按钮 */
    public static final String NOACCESS = "false";

    private static final String ACCESS = "true";
    ...
    {
        return isLacksPermitted(permission) ? ACCESS : NOACCESS;
    }
    ...
    {
        return hasAnyPermissions(permissions, PERMISSION_DELIMETER) ? ACCESS : NOACCESS;
    }
    ...
    {
        return isRole(role) ? ACCESS : NOACCESS;
    }
    ...
    {
        return isLacksRole(role) ? ACCESS : NOACCESS;
    }
    ...
    {
        return isAnyRoles(roles, ROLE_DELIMETER) ? ACCESS : NOACCESS;
    }
